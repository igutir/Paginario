...
from .models import Libro, Usuario, Autor, Editorial, Lista, Estado_Libro, Usuario_Libro

import traceback, requests, environ, datetime
...
# Obtiene el usuario actual que está navegando el sitio
...
# Obtiene la reseña desde el request y la ingresa en la base de datos
